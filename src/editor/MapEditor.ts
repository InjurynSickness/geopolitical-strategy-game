...
export class MapEditor {
    private currentPaintCountry: string | null = null;

    constructor(
        private provinceOwnerMap: Map<string, string>,
    ...
    public paintProvince(x: number, y: number, isRightClick: boolean): boolean {
    ...
    private detectCountryFromName(provinceName: string): string | null {
...
`;
    ...
    public getCurrentPaintCountry(): string | null {
