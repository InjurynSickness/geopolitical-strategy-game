...
export class EventManager {
    public showSimpleEventPopup(event: GameEvent, country: Country, onComplete: () => void): void {
        ...
        for (const choice of event.choices) {
            ...
            if (!hasEnoughPP) choiceButton.classList.add('insufficient-power');
    ...
    public createTestEvent(country: Country, showNotification: (msg: string, type: string) => void): GameEvent {
        return {
