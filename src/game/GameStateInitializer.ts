...
import { Country, GameState, Alliance, GovernmentType, Ideology } from '../types.js';
    ...
    public static initializeGameState(): GameState {
        ...
        for (const majorCountryData of gameData.countries) {
            ...
            Object.assign(country, {
                ...
                government: majorCountryData.government as GovernmentType,
                ideology: majorCountryData.ideology as Ideology,
                resources: majorCountryData.resources as any
            });
        }
        ...
        for (const allianceData of gameData.alliances) {
            alliances.set(allianceData.id, allianceData as Alliance);
        }
